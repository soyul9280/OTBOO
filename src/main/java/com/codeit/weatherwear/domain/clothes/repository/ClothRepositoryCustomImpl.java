...
import com.codeit.weatherwear.domain.clothes.entity.QClothWithAttributes;
...
public class ClothRepositoryCustomImpl implements ClothRepositoryCustom {
  ...
  @Override
  public List<Cloth> findAllByIdWithAttributes(List<UUID> clothIds) {
  ...
  @Override
  public List<Cloth> findAllWithAttributesByUserId(UUID userId) {
    QCloth cloth = QCloth.cloth;
    return queryFactory
        .selectFrom(cloth)
